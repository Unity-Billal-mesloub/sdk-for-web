...
**This SDK is compatible with Appwrite server version 1.9.x. For older versions, please check [previous releases](https://github.com/Unity-Billal-mesloub/sdk-for-web/releases).**

Appwrite is an open-source backend as a service server that abstracts and simplifies complex and repetitive development tasks behind a very simple to use REST API. Appwrite aims to help you develop your apps faster and in a more secure way. Use the Web SDK to integrate your app with the Appwrite server to easily start interacting with all of Appwrite backend APIs and tools. For full API documentation and tutorials go to [https://appwrite.io/docs](https://appwrite.io/docs)

![Appwrite](https://raw.githubusercontent.com/appwrite/appwrite/main/public/images/github.png)
...
This library is auto-generated by Appwrite custom [SDK Generator](https://github.com/Unity-appwrite/sdk-generator). To learn more about how you can help us improve this SDK, please check the [contribution guide](https://github.com/Unity-appwrite/sdk-generator/blob/main/CONTRIBUTING.md) before sending a pull-request.
